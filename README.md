...
## 安装命令
```
source <(curl -sL https://raw.githubusercontent.com/cherry90060/multi-v2ray/master/v2ray.sh) --zh
```

## 升级命令(保留配置文件更新)
```
source <(curl -sL https://raw.githubusercontent.com/cherry90060/multi-v2ray/master/v2ray.sh) -k
```

## 卸载命令
```
source <(curl -sL https://raw.githubusercontent.com/cherry90060/multi-v2ray/master/v2ray.sh) --remove
```
